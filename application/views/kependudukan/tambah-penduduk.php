            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/tambah_penduduk'); ?>" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_kk" name="no_kk" placeholder="Masukkan No Kartu Keluarga">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Misal : Jln. A Blok B No.01 Rt.01 Rw.01">
                                </div>
                                <div class="form-group">
                                    <label for="telp">Telepon</label>
                                    <input type="text" class="form-control" id="telp" name="telp" placeholder="Masukkan No Telepon">
                                </div>
                                <div class="form-group">
                                    <div class="radio">
                                        <label>
