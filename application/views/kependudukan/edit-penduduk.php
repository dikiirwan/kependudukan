            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/edit_penduduk/{{id}}'); ?>" method="post">
                            <?php foreach ($penduduk as $pd) : ?>
                                <input type="text" class="hide" value="<?= $pd['id_penduduk']; ?>" id="id_penduduk" name="id_penduduk" readonly>
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="no_ktp">No KTP</label>
                                        <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="<?= $pd['no_ktp']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="no_ktp">No KK</label>
                                        <input type="text" class="form-control" id="no_kk" name="no_kk" value="<?= $pd['no_kk']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="nama">Nama</label>
                                        <input type="text" class="form-control" id="nama" name="nama" value="<?= $pd['nama']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat">Alamat</label>
                                        <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $pd['alamat']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="telp">Telepon</label>
                                        <input type="text" class="form-control" id="telp" name="telp" value="<?= $pd['telp']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <div class="radio">
                                            <label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" name="tgl_lahir" value="<?= $pd['tgl_lahir']; ?>">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="<?= base_url('kependudukan/data_penduduk'); ?>" class="btn btn-info">Kembali</a>
                                </div>
                                </div>
                        </form>
                    </div>
