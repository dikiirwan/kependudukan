            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/edit_pendatang/{{id}}'); ?>" method="post">
                            <?php foreach ($pendatang as $pd) : ?>
                                <input type="text" class="hide" value="<?= $pd['id_pendatang']; ?>" id="id_pendatang" name="id_pendatang" readonly>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="asal" name="asal" value="<?= $pd['asal']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="tujuan">Tujuan</label>
                                        <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?= $pd['tujuan']; ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" name="tgl_datang" value="<?= $pd['tgl_datang']; ?>">
                                        </div>
                                        <!-- /.input group -->
                                        </!-->
                                        <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a href="<?= base_url('kependudukan/data_pendatang'); ?>" class="btn btn-info">Kembali</a>
                                    </div>
                                    </div>
                        </form>
                    </div>
