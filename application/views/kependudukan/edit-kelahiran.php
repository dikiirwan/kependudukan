            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/edit_kelahiran/{{id}}'); ?>" method="post">
                            <?php foreach ($kelahiran as $kl) : ?>
                                <input type="text" class="hide" value="<?= $kl['id_kelahiran']; ?>" id="id_kelahiran" name="id_kelahiran" readonly>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tmpt_lahir" name="tmpt_lahir" value="<?= $kl['tmpt_lahir']; ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" name="tgl_lahir" value="<?= $kl['tgl_lahir']; ?>">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <div class="form-group">
                                        <label for="no_ktp">No KTP Ayah</label>
                                        <input type="text" class="form-control" id="no_ktp_ayah" name="no_ktp_ayah" value="<?= $kl['no_ktp_ayah']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="no_ktp">No KTP Ibu</label>
                                        <input type="text" class="form-control" id="no_ktp_ibu" name="no_ktp_ibu" value="<?= $kl['no_ktp_ibu']; ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="<?= base_url('kependudukan/data_kelahiran'); ?>" class="btn btn-info">Kembali</a>
                                </div>
                                </div>
                        </form>
                    </div>
