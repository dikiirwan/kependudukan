            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/edit_kematian/{{id}}'); ?>" method="post">
                            <?php foreach ($kematian as $km) : ?>
                                <input type="text" class="hide" value="<?= $km['id_kematian']; ?>" id="id_kematian" name="id_kematian" readonly>
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" name="tgl_kematian" value="<?= $km['tgl_kematian']; ?>">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <div class="form-group">
                                        <label for="no_ktp">No KTP</label>
                                        <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="<?= $km['no_ktp']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="no_kk">No KK</label>
                                        <input type="text" class="form-control" id="no_kk" name="no_kk" value="<?= $km['no_kk']; ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="<?= base_url('kependudukan/data_kematian'); ?>" class="btn btn-info">Kembali</a>
                                </div>
                                </div>
                        </form>
                    </div>
