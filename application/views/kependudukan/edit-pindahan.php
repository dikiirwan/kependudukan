            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/edit_pindahan/{{id}}'); ?>" method="post">
                            <?php foreach ($pindahan as $pn) : ?>
                                <input type="text" class="hide" value="<?= $pn['id_pindahan']; ?>" id="id_pindahan" name="id_pindahan" readonly>
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="no_ktp">No KTP</label>
                                        <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="<?= $pn['no_ktp']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="nama">Nama</label>
                                        <input type="text" class="form-control" id="nama" name="nama" value="<?= $pn['nama']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?= $pn['tujuan']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
