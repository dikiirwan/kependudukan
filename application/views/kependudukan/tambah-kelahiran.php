            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <form action="<?= base_url('kependudukan/tambah_kelahiran'); ?>" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tmpt_lahir" name="tmpt_lahir" placeholder="Masukkan Tempat Kelahiran">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_ktp_ayah" name="no_ktp_ayah" placeholder="Masukkan No KTP Ayah">
                                </div>
                                <div class="form-group">
                                    <label for="no_ktp">No KTP Ibu</label>
                                    <input type="text" class="form-control" id="no_ktp_ibu" name="no_ktp_ibu" placeholder="Masukkan No KTP Ibu">
                                </div>
                                <div class="form-group">
